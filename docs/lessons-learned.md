...
I built this project to make a specific system design problem concrete: Enterprises will run many specialized AI agents, and the hard problem is safe orchestration: tools, permissions, handoffs, conflicts, approvals, traces, and auditability.
