...
- `python -m src.pipeline.run_all`: passed in 0.92s
- `python scripts/validate_showcase_docs.py`: passed in 0.02s
- `python -m pytest`: passed in 1.77s (145 tests)
...
- `python -m pytest`: passed (146 tests)
