...
This document explains the lightweight future-enhancement scorecard added for `agentic-enterprise-runtime`.
...
- real agent SDK adapter
- OPA policy engine
- OpenTelemetry traces
- ServiceNow/Jira approval workflow
